...
Don’t stop when you’ve got something working. Spend some time refining your code (e.g. refactoring, removing redundancy). Measure the speed of your solution (see [[18-4|18.4 -- Timing your code]]) and then see if you can find ways to optimize your code so it performs faster!
