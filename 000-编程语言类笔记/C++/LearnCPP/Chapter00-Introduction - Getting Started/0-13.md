...
If you get an error while trying to build this, you may have your project set up incorrectly. See [[0-8|0.8 -- A few common C++ problems]] for advice on some common issues. If that does not help, review the lessons starting from [[0-6|0.6 -- Installing an Integrated Development Environment (IDE)]].
...
- Check your IDE settings to ensure your compiler is configured to use the language standard you expect. See [[0-12|0.12 -- Configuring your compiler: Choosing a language standard]] for more information on how to do this for some of the major compilers. Make sure there are no typos or formatting errors. Some compilers require setting the language standard for each project rather than globally, so if you’ve just created a new project, this may be the case.
