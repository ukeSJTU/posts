...
> **Related content**
>
> We discuss the outputting of characters and text in lesson [[1-5|1.5 -- Introduction to iostream: cout, cin, and endl]].
> We discuss characters (including control characters) in more detail in lesson [[4-11|4.11 -- Chars]].
...
If you run into issues compiling or executing this program, check out lesson [[0-8|0.8 -- A few common C++ problems]].
...
Hint: Review lesson
[[0-5|0.5 -- Introduction to the compiler, linker, and libraries]]
