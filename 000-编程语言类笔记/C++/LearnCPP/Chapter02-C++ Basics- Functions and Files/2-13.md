...
- Clean the house- Vacuum the carpets
  - Clean the bathrooms
  - Clean the kitchen
...
- Clean the house- Vacuum the carpets
  - Clean the bathrooms- Scrub the toilet (yuck!)
    - Wash the sink
  - Clean the kitchen- Clear the countertops
...
- Get from bed to work- Bedroom things- Turn off alarm
  - Get out of bed
  - Pick out clothes
  - Bathroom things- Take a shower
    - Get dressed
    - Brush your teeth
  - Breakfast things- Make coffee or tea
    - Eat cereal
  - Transportation things- Get on your bicycle
    - Travel to work
...
> **Related content**
>
> We cover testing in more detail in lesson [[9-1|9.1 -- Introduction to testing your code]].
