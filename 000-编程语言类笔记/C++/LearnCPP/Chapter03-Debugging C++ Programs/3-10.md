...
One common method of doing this is via _assert_ and _static_assert_, which we cover in lesson [[9-6|9.6 -- Assert and static_assert]].
...
You already have one static analysis tool at your disposal -- your compiler! In addition to ensuring your program is syntactically correct, most modern C++ compilers will do some light static analysis to identify some common problems. For example, many compilers will warn you if you try to use a variable that has not been initialized. If you haven’t already, turning up your compiler warning and error levels (see lesson [[0-11|0.11 -- Configuring your compiler: Warning and error levels]]) can help surface these.
...
>
> Visual Studio 2019 onward comes with a built-in static analysis tool. You can access it via _Build > Run Code Analysis on Solution (Alt+F11)_.
