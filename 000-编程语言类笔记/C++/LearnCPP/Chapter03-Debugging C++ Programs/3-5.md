...
In the previous lesson ([[3-4|3.4 -- Basic debugging tactics]]), we started exploring how to manually debug problems. In that lesson, we offered some criticisms of using statements to print debug text:
