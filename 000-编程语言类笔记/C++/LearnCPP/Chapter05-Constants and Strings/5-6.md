...
In the previous lesson [[5-5|5.5 -- Constant expressions]], we defined what a constant expression is, discussed why constant expressions are desirable, and concluded with when constant expressions actually evaluate at compile-time.
...
> C++ also supports a way to pass compile-time constants to a function. We discuss these in lesson [[11-9|11.9 -- Non-type template parameters]].
