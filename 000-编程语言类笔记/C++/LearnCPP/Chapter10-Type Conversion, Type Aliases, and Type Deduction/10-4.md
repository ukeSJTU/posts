...
In the previous lesson ([[10-3|10.3 -- Numeric conversions]]), we covered numeric conversions, which cover a wide range of different type conversions between fundamental types.
