...
This is more often done with classes, so we’ll talk more about this in a future lesson ([[15-3|15.3 -- Nested types (member types)]]).

---

## Structs that are owners should have data members that are owners

In lesson [[5-9|5.9 -- std::string_view (part 2)]], we introduced the dual concepts of owners and viewers. Owners manage their own data, and control when it is destroyed. Viewers view someone else’s data, and do not control when it is altered or destroyed.
