...
In the prior lesson ([[13-4|13.4 -- Converting an enumeration to and from a string]]), we showed this example, where we used a function to convert an enumeration into an equivalent string:
...
>
> Operators can also be overloaded as member functions of the left-most operand. We discuss this in lesson [[21-5|21.5 -- Overloading operators using member functions]].
...
> **Key insight**
>
> Our right operand ( `pet` ) is an out parameter. We cover out parameters in lesson [[12-13|12.13 -- In and out parameters]].
...
> **Related content**
>
> In lesson [[17-6|17.6 -- std::array and enumerations]], we show how we can use `std::array` to make our input and output operators less redundant, and avoid having to modify them when a new enumerator is added.
