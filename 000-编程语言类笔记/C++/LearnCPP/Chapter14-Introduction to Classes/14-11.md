...
However, as we already covered in lesson [[13-9|13.9 -- Default member initialization]], value initialization is safer for aggregates. Since it’s difficult to tell whether a class type is an aggregate or non-aggregate, it’s safer to just use value initialization for everything and not worry about it.
...
> **Related content**
>
> We cover default arguments in lesson [[11-5|11.5 -- Default arguments]].
...
We’ll see examples of where this can be useful in the next lesson ([[14-12|14.12 -- Delegating constructors]]).
