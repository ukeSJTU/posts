...
In lesson [[14-7|14.7 -- Member functions returning references to data members]], we discussed how calling access functions that return references to data members can be dangerous when the implicit object is an rvalue. Here’s a quick recap:
...
> We cover  `std::move`  in lesson [[22-4|22.4 -- std::move]].
> ````
