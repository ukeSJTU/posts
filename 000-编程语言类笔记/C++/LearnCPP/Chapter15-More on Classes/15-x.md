...
h) Now we’ll randomize our generated monster. Grab the “Random.h” code from [[8-15|8.15 -- Global random numbers (Random.h)]] and save it as Random.h. Then use `Random::get()` to generate a random monster type, random name, random roar, and random hit points (between 1 and 100).
