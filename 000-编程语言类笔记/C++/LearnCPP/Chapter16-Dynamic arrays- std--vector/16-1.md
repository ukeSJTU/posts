...
In lesson [[5-7|5.7 -- Introduction to std::string]], we showed how we could use the `length` member function of `std::string` to get the number of character elements in the string container:
