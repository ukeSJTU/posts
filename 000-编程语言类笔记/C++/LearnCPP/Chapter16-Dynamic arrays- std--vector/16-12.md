...
>
> When a template class has a different implementation for a particular template type argument, this is called **class template specialization**. We discuss this topic further in lesson [[26-4|26.4 -- Class template specialization]].
