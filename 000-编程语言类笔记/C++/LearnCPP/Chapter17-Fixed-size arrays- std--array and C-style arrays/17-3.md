...
> **Related content**
>
> We cover function templates in lesson [[11-6|11.6 -- Function templates]].
...
> **Related content**
>
> We cover preconditions in lesson [[9-6|9.6 -- Assert and static_assert]].
...
> **Key insight**
>
> In the example above, you may be wondering why we use `static_assert (N > 3);` instead of `static_assert (std::size(arr) > 3)` . The latter won’t compile prior to C++23 due to the language defect mentioned in the prior lesson ([[17-2|17.2 -- std::array length and indexing]]).
