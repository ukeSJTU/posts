...
In lesson [[8-10|8.10 -- For statements]], we noted that using `operator<` was preferred over `operator!=` when doing numeric comparisons in the loop condition:
