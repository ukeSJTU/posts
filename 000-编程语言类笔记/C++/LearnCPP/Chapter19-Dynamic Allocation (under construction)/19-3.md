...
> ```We discuss  `=delete`  for members in lesson [[14-14|14.14 -- Introduction to the copy constructor]]
> ````
...
> **A reminder**
>
> In lesson [[16-2|16.2 -- Introduction to std::vector and list constructors]], we note that parentheses based initialization should be used when initializing an array/container/list class with a length (as opposed to a list of elements). For this reason, we initialize IntArray using `IntArray ar ( 10 );` .
