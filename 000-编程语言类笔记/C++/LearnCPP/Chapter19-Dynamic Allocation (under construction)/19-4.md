...
Another common use for pointers to pointers is to facilitate dynamically allocated multidimensional arrays (see [[17-12|17.12 -- Multidimensional C-style Arrays]] for a review of multidimensional arrays).
...
However, if we want a function to be able to modify what a pointer argument points to, this is generally better done using a reference to a pointer instead. This is covered in lesson [[12-11|12.11 -- Pass by address (part 2)]].
