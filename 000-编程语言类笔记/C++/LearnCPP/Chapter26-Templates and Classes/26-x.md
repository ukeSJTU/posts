...
Hint: To define a template using two different types, separate the two types by a comma in the template parameter declaration. See lesson [[11-8|11.8 -- Function templates with multiple template types]] for more information.
