...
In the previous lesson on [[27-2|27.2 -- Basic exception handling]], we explained how throw, try, and catch work together to enable exception handling. In this lesson, we’ll talk about how exception handling interacts with functions.
...
> **Related content**
>
> Before proceeding, see lesson [[20-2|20.2 -- The stack and the heap]] if you need a refresher on call stacks and stack unwinding.
...
If no matching exception handler is found, the stack may or may not be unwound. We will talk more about this case in the next lesson ([[27-4|27.4 -- Uncaught exceptions and catch-all handlers]]).
