...
> **Related content**
>
> We cover `std::unique_ptr` in lesson [[22-5|22.5 -- std::unique_ptr]].
...
Unlike constructors, where throwing exceptions can be a useful way to indicate that object creation did not succeed, exceptions should _never_ be thrown in destructors.
