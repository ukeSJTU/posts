...
In lesson [[5-5|5.5 -- Constant expressions]], we noted that in contexts that do not _require_ a constant expression, the compiler may choose whether to evaluate a constant expression at either compile-time or at runtime. Accordingly, any constexpr function call that is part of a non-required constant expression may be evaluated at either compile-time or runtime.
...
> **Related content**
>
> If you need parameters that are constant expressions, see [[11-9|11.9 -- Non-type template parameters]].
...
> **Related content**
>
> We cover the as-if rule in lesson [[5-5|5.5 -- Constant expressions]].
